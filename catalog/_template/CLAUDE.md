...
<!-- Reference any commands installed by this pack. -->

<!-- - `/pack-command` — short description of what it does -->

## Tool use preferences

<!-- Instruct Claude how to use tools in this context. -->

<!-- - Prefer the `Read` tool over `cat` for reading files. -->
